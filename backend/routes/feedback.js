...
// POST /api/feedback — cualquier usuario autenticado puede enviar
router.post(
  "/",
  authorize(...ALL_ROLES),
...
// PATCH /api/feedback/:id/leido — marcar como leído (ADMIN)
router.patch(
  "/:id/leido",
  authorize(ROLES.ADMIN),
  asyncHandler(async (req, res) => {
...
// GET /api/feedback/count — badge para ADMIN
router.get(
  "/count",
  authorize(ROLES.ADMIN),
  asyncHandler(async (req, res) => {
